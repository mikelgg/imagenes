...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Passive Storage Notice */}
      <div className="fixed bottom-4 left-4 right-4 z-40">
        <div className="max-w-7xl mx-auto">
          <div 
            className="bg-surface/95 backdrop-blur-sm border border-border/50 rounded-lg px-4 py-2 text-center"
            role="status"
          >
            <p className="text-xs text-text-muted">
              Aviso: se guardará 1 imagen por lote en almacenamiento temporal durante 24 h por motivos de privacidad.
            </p>
          </div>
        </div>
      </div>
